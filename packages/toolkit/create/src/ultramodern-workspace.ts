...
assert(rootPackage.devDependencies?.['@modern-js/ultramodern-checks'] === expectedModernPackageSpecifier('@modern-js/ultramodern-checks'), 'Root ultramodern-checks dependency must match package source metadata');
