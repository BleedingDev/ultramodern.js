 ...
 */
export const TANSTACK_ROUTER_VERSION = '1.170.15';
export const MODULE_FEDERATION_VERSION = '2.5.1';
export const ZEPHYR_RSPACK_PLUGIN_VERSION = '1.1.1';
export const ZEPHYR_AGENT_VERSION = '1.1.1';
export const WRANGLER_VERSION = '4.99.0';
export const CLOUDFLARE_COMPATIBILITY_DATE = '2026-06-02';
export const TAILWIND_VERSION = '4.3.0';
export const TAILWIND_POSTCSS_VERSION = '4.3.0';
export const POSTCSS_VERSION = '8.5.15';
export const EFFECT_TSGO_VERSION = '0.14.3';
export const TYPESCRIPT_VERSION = '6.0.3';
export const TYPESCRIPT_NATIVE_PREVIEW_VERSION = '7.0.0-dev.20260610.1';
export const OXLINT_VERSION = '1.69.0';
export const OXFMT_VERSION = '0.54.0';
...
export const PNPM_VERSION = '11.5.3';
