...
export const EFFECT_TSGO_VERSION = '0.14.0';
export const TYPESCRIPT_VERSION = '6.0.3';
export const TYPESCRIPT_NATIVE_PREVIEW_VERSION = '7.0.0-dev.20260606.1';
export const OXLINT_VERSION = '1.68.0';
export const OXFMT_VERSION = '0.53.0';
