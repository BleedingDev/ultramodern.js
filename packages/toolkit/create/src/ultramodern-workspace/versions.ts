...
export const EFFECT_VERSION = '4.0.0-beta.94';
export const EFFECT_VITEST_VERSION = '4.0.0-beta.94';
export const EFFECT_TSGO_VERSION = '0.16.3';
...
export const PNPM_VERSION = '11.10.0';
