...
`pnpm-workspace.yaml` overrides: `effect@4.0.0-beta.94`,
`@effect/opentelemetry@4.0.0-beta.94`, and
`@effect/vitest@4.0.0-beta.94`. The generated pnpm policy also excludes the
known `effect@4.0.0-beta.94` and `@effect/opentelemetry@4.0.0-beta.94`
