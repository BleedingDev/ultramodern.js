...
:::tip
If your project was created with `--router tanstack`, use `@modern-js/plugin-tanstack/runtime` in route code. If you use the built-in runtime export directly, use `@modern-js/runtime/tanstack-router`.
:::
...
Modern.js exposes the same helper APIs from the standalone TanStack plugin and from the built-in runtime export.

| Scenario | Runtime APIs | Server-only RSC helpers | Client RSC helpers |
|---------|--------------|--------------------------|--------------------|
| Standalone TanStack plugin | `@modern-js/plugin-tanstack/runtime` | `@modern-js/plugin-tanstack/runtime/rsc/server` | `@modern-js/plugin-tanstack/runtime/rsc/client` |
| Built-in runtime export | `@modern-js/runtime/tanstack-router` | `@modern-js/runtime/tanstack-router/rsc/server` | `@modern-js/runtime/tanstack-router/rsc/client` |

Use the standalone paths in projects created with the TanStack plugin. The examples below use those paths.
