...
## Migration Note (mvfh-06)

For teams already on Modern.js v3, the mvfh-06 path is compatibility-first: keep the Modern.js mental model, move toward MV-first / TanStack-first / Effect-first defaults, and keep fallback lanes explicit while you migrate.
...
4. Keep mvfh-07 work separate. This note is only about compatibility and migration steps; release gates, certification, and evidence ownership are outside the mvfh-06 scope.
