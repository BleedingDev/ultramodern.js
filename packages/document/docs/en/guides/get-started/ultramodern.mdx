...
This page compares **UltraModern.js 3.0** with the Modern.js 3.x line this fork tracks. The current fork packages are `3.2.0`, and the baseline should be read as the current merged Modern.js `release-v3.x` baseline, not a frozen patch snapshot.
