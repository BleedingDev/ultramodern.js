...
The workspace pins Node `>=26` and `packageManager: pnpm@11.17.0`, writes `.mise.toml` with pnpm `11.17.0`, and records mise as the toolchain in `.modernjs/ultramodern-generated-contract.json`.
