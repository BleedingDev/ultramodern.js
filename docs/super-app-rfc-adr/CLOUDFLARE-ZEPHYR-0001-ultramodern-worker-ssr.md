...
No corepack source of truth is generated. The workspace pins `packageManager: pnpm@11.3.0` and records the toolchain policy as mise in `.modernjs/ultramodern-generated-contract.json`.
