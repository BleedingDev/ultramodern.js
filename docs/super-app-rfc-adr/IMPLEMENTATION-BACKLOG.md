...
| Epic ID | Epic | ADR | Suggested Owner | Effort | Parallelization | Depends On |
| --- | --- | --- | --- | --- | --- | --- |
| EPIC-1 | RsDoctor Default-On | ADR-0001 | Platform Build | M | Parallel | None |
| EPIC-2 | Cross-Project BFF Hardening | ADR-0005 | BFF Platform | L | Parallel | None |
| EPIC-3 | Telemetry Standardization + Exporters | ADR-0004 | Observability Platform | L | Parallel | None |
| EPIC-4 | Effect-Only MF Data-Fetch Reliability | ADR-0003 | Runtime Federation + QA Infra | L | Parallel-start, partial sequential | EPIC-2 (partial) |
| EPIC-5 | App-Level MF SSR | ADR-0002 | Runtime Federation | XL | Mostly sequential | EPIC-2, EPIC-4 |
