# MIGRATION-PLAYBOOK-0003: UltraModern 3.4.0-ultramodern.13

- Status: Accepted
- Date: 2026-06-27
- From: `3.4.0-ultramodern.12`
- To: `3.4.0-ultramodern.13`
- Related packages: `@bleedingdev/modern-js-create`,
  `@bleedingdev/modern-js-app-tools`, `@bleedingdev/modern-js-builder`

## 1. Purpose

`3.4.0-ultramodern.13` is the cleanup release for generated UltraModern.js
...
```bash
pnpm dlx @bleedingdev/modern-js-create@3.4.0-ultramodern.13 my-workspace \
  --ultramodern-package-source install \
  --ultramodern-package-version 3.4.0-ultramodern.13
```
...
```bash
pnpm dlx @bleedingdev/modern-js-create@3.4.0-ultramodern.13 app-name \
  --ultramodern-package-source install \
  --ultramodern-package-version 3.4.0-ultramodern.13 \
  --bridge \
  --bridge-parent-root ../.. \
