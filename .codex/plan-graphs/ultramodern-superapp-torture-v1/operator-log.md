...
| soak-stability | `019de339-7dae-75e1-97c6-cc932d6c9b35` (`Aquinas`) | worker | in_progress | Owns `ust-soak-04`: drift detectors for memory growth, p95/p99 latency degradation, error-rate increases, stalled resets, and unreleased handles plus soak plan status only. |

## Current Frontier

Refreshed: 2026-05-01 13:08 CEST

- Active: `ultramodern-superapp-torture-soak-stability` / `ust-soak-04` is running under Aquinas (`019de339-7dae-75e1-97c6-cc932d6c9b35`); `ust-soak-05` remains pending.
