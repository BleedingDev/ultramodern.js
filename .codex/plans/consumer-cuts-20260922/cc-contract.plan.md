...
- package.json dependencies and the pnpm lockfile own requested and resolved dependency versions. The installed framework owns release expectations. No application release-cohort.json.
