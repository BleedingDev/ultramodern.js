...
Implementation accounting at `09442a027c` against `4031db83e3`: the three affected package `src/` trees fell from 40,503 to 36,360 physical JS/TS lines, a reduction of 4,143. Fresh shell/UI/API fixtures have zero forwarding scripts and zero consumer patches; the initial generated source/script baseline measured 1,674/2,610/2,364 versus 1,737/2,737/2,565 at baseline. The rejected 1,357,318-line expanded dependency payload was removed before commit; release staging reconstructs it from pinned recipes.
