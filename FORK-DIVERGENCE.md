...
```json
{
  ...
  "entries": [
    ...
    {"path":"packages/runtime/plugin-i18n/src/server/index.ts","owner":"bleedingdev","reason":"Register the fork-owned localized loader plugin through ServerPlugin.usePlugins so bare i18n consumers retain translated client navigation without the UltraModern compositor.","dispositions":["extension-point"]},
    {"path":"packages/runtime/plugin-i18n/package.json","owner":"bleedingdev","reason":"Declare the server extension dependency used by the i18n server plugin to install localized loader resolution for all supported compositions.","dispositions":["extension-point"]},
...
| `packages/runtime/plugin-i18n/src/server/index.ts` | bleedingdev | Register the fork-owned localized loader plugin through ServerPlugin.usePlugins so bare i18n consumers retain translated client navigation without the UltraModern compositor. | `extension-point` |
| `packages/runtime/plugin-i18n/package.json` | bleedingdev | Declare the server extension dependency used by the i18n server plugin to install localized loader resolution for all supported compositions. | `extension-point` |
