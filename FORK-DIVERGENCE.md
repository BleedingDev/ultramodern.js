...
```json
{
  ...
  "entries": [
    ...
    {"path":"packages/cli/plugin-bff/tests/server.test.ts","owner":"bleedingdev","reason":"Verify native Hono defaults and lifecycle/prefix behavior, finite registered adapter module dispatch, missing/malformed adapter errors and isolation from unselected extension modules. Effect default/composition assertions live in the higher extension integration suite.","dispositions":["inline-patch"]},
