...
```json
{
  ...
  "entries": [
    ...
    {"path":"packages/toolkit/utils/src/cli/require.ts","owner":"bleedingdev","reason":"Read JSON directly and normalize only Node-marked CJS namespaces and tagged transpiler defaults. Preserve genuine ESM payloads, named-only namespaces, raw interop and development reload behavior when loading server-plugin factories.","dispositions":["inline-patch"]},
